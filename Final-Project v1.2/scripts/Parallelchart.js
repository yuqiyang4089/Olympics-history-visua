...
var title  = svg.append("g").attr("id", "paralleltitle").attr("transform", "translate(-70,0)");
title.append("text")
  .attr("y", "10px")
  .style("font-weight", "bold")
  .text("Athlete's Physical Fitness");
title.append("text")
  .attr("y", "30px")
  .text("Country: " + Nname);
title.append("text")
...
var svg_ = d3.select("body").append("svg").attr("class","parallelchart2")
...
d3.csv("./data/parallel_non-NA.csv", function(error, data) {
  ...
  background_ = svg_.append("g")

      .attr("class", "background_")
  ...
  foreground_ = svg_.append("g")

      .attr("class", "foreground_")
  ...
  var g = svg_.selectAll(".dimension")
    ...
    .enter().append("g")
      ...
      .call(d3.drag()
        ...
        .on("start", function(d) {
          ...
          background_.attr("visibility", "hidden");
        ...
        .on("end", function(d) {
          ...
          transition(foreground_).attr("d", path);
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++plus
  ...
  foreground_.style('display', function(d) {

    return actives_.every(function(active) {
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++
  d3.selectAll(".actpath").each(function(d){
    ...
    d3.select(".videoci-"+d.ID).select(".y"+d.Year).attr("fill", "red");
